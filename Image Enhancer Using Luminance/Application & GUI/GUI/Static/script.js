// Listen for DOMContentLoaded event to ensure all DOM elements are loaded
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (listView && gridView && projectsList) {
        // Add event listeners to list and grid view buttons
    ...
    if (messagesBtn && messagesSection && messagesClose) {
        // Add event listeners to show and hide messages section
        ...
        // Close messages section when clicking outside of it
        window.addEventListener("click", function(event) {
            if (
                event.target !== messagesSection &&
                !messagesSection.contains(event.target)
            ) {
                messagesSection.classList.remove("show");
            }
        });
    ...
    // Initialize image comparison viewer
    ...
    // Add 'dark' class to set dark theme as default
    document.documentElement.classList.add("dark");

    const modeSwitch = document.querySelector(".mode-switch");

    modeSwitch.addEventListener("click", function() {
        // Toggle dark mode on mode switch click
    ...
    // Add Fullscreen Event Listener to fullscreen buttons
    document
        .querySelectorAll(".image-container .fullscreen-btn")
        .forEach((btn) => {
    ...
    function compareImages() {
        ...
        var imageName = document.getElementById("file-name-display").innerText;

        // Open a new window with the compare.html and pass the image name as a query parameter
        var newWindow = window.open(
            "Image%20Comparison%20Slider/compare.html?" +
        ...
        if (newWindow) {
            ...
            alert(
                "Please allow pop-ups for this site to open the comparison window."
            );
        }
    }
    ...
    document.getElementById('Download_button').addEventListener('click', async function() {
        ...
        if (window.showSaveFilePicker) {
            ...
            // Define options for the save file dialog
            const options = {
                suggestedName: 'enhanced_image.png',
                types: [{
            ...
            // Show save file dialog and get a file handle
            ...
            showNotification('Your browser does not support the File System Access API.');
        }
    });
    ...
    async function checkServerStatus() {
        ...
        try {
            const response = await fetch('http://localhost:5000/check_server_status');
            if (!response.ok) {
    ...
    // Modify your start button click event to check server status
    document.getElementById('startButton').addEventListener('click', async function() {
        try {
            ...
            originalImg.onload = function() {
                var originalResolution = originalImg.naturalWidth + 'x' + originalImg.naturalHeight;
                // Display the original resolution alongside the image name
                var originalResolutionElement = document.getElementById('original-resolution');
                originalResolutionElement.innerText = 'Original Resolution: ' + originalResolution;
            };
            var originalReader = new FileReader();
            originalReader.onload = function(event) {
            ...
            fetch('http://localhost:5000/process_image', {
                ...
                .then((response) => {
                    if (response.ok) {
                        ...
                        var processingTime = (endTime - startTime) / 1000; // Convert to seconds

                        // Update processing time in HTML
                ...
                .then((blob) => {
                    ...
                    // Get the enhanced resolution of the image
                    var enhancedImg = new Image();
                    enhancedImg.onload = function() {
                        var enhancedResolution = enhancedImg.naturalWidth + 'x' + enhancedImg.naturalHeight;
                        // Display the enhanced resolution alongside the image name
                        var enhancedResolutionElement = document.getElementById('enhanced-resolution');
                        enhancedResolutionElement.innerText = 'Enhanced Resolution: ' + enhancedResolution;
                    };
...
function updateProcessingTime(time) {
    var processingTimeElement = document.getElementById('processing-time');
    processingTimeElement.innerText = 'Processing Time: ' + time + ' seconds';
}
...
function compareImages() {
    ...
    // Open a new window with the compare.html and pass the image name as a query parameter
    var newWindow = window.open(
        "Image%20Comparison%20Slider/compare.html?imageName=" +
        encodeURIComponent(imageName),
        "_blank"
    );
    if (newWindow) {
...
//*************************************************************************************************************************//
! function(t, n) { "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define("ImageCompare", [], n) : "object" == typeof exports ? exports.ImageCompare = n() : t.ImageCompare = n() }(self, (function() {
    return function() {
        var t = {
                9662: function(t, n, e) {
                    var r = e(614),
                ...
                1223: function(t, n, e) {
                    var r = e(5112),
                        ...
                        c = r("unscopables"),
                        a = Array.prototype;
                    null == a[c] && i(a, c, { configurable: !0, value: o(null) }), t.exports = function(t) { a[c][t] = !0 }
                },
                9670: function(t, n, e) {
                    var r = e(111),
                        o = String,
                ...
                9341: function(t, n, e) {
                    "use strict";
                    var r = e(7293);
                    t.exports = function(t, n) { var e = [][t]; return !!e && r((function() { e.call(null, n || function() { return 1 }, 1) })) }
                },
                1589: function(t, n, e) {
                    var r = e(1400),
                        o = e(6244),
                        ...
                        c = Array,
                        a = Math.max;
                    t.exports = function(t, n, e) { for (var s = o(t), u = r(n, s), f = r(void 0 === e ? s : e, s), l = c(a(f - u, 0)), d = 0; u < f; u++, d++) i(l, d, t[u]); return l.length = d, l }
                },
                206: function(t, n, e) {
                    var r = e(1702);
                    t.exports = r([].slice)
                ...
                7475: function(t, n, e) {
                    var r = e(3157),
                        ...
                        c = e(5112)("species"),
                        a = Array;
                    t.exports = function(t) { var n; return r(t) && (n = t.constructor, (o(n) && (n === a || r(n.prototype)) || i(n) && null === (n = n[c])) && (n = void 0)), void 0 === n ? a : n }
                },
                5417: function(t, n, e) {
                    var r = e(7475);
                    t.exports = function(t, n) { return new(r(t))(0 === n ? 0 : n) }
                },
                3411: function(t, n, e) {
                    var r = e(9670),
                        o = e(9212);
                    t.exports = function(t, n, e, i) { try { return i ? n(r(e)[0], e[1]) : n(e) } catch (n) { o(t, "throw", n) } }
                },
                7072: function(t, n, e) {
                ...
                648: function(t, n, e) {
                    ...
                    t.exports = r ? i : function(t) { var n, e, r; return void 0 === t ? "Undefined" : null === t ? "Null" : "string" == typeof(e = function(t, n) { try { return t[n] } catch (t) {} }(n = a(t), c)) ? e : s ? i(n) : "Object" == (r = i(n)) && o(n.callee) ? "Arguments" : r }
                },
                9920: function(t, n, e) {
                    var r = e(2597),
                        o = e(3887),
                ...
                4994: function(t, n, e) {
                    ...
                    t.exports = function(t, n, e, u) { var f = n + " Iterator"; return t.prototype = o(r, { next: i(+!u, e) }), c(t, f, !1, !0), a[f] = s, t }
                },
                8880: function(t, n, e) {
                    var r = e(9781),
                        o = e(3070),
                ...
                9114: function(t) { t.exports = function(t, n) { return { enumerable: !(1 & t), configurable: !(2 & t), writable: !(4 & t), value: n } } },
                6135: function(t, n, e) {
                    "use strict";
                    var r = e(4948),
                        o = e(3070),
                ...
                8052: function(t, n, e) {
                    ...
                    t.exports = function(t, n, e, a) {
                        ...
                        return r(e) && i(e, u, a), a.global ? s ? t[n] = e : c(n, e) : (a.unsafe ? t[n] && (s = !0) : delete t[n], s ? t[n] = e : o.f(t, n, { value: e, enumerable: !1, configurable: !a.nonConfigurable, writable: !a.nonWritable })), t
                    }
                },
                3072: function(t, n, e) {
                    var r = e(7854),
                        o = Object.defineProperty;
                    t.exports = function(t, n) { try { o(r, t, { value: n, configurable: !0, writable: !0 }) } catch (e) { r[t] = n } return n }
                },
                654: function(t, n, e) {
                    "use strict";
                    var r = e(2109),
                    ...
                    t.exports = function(t, n, e, c, v, g, A) {
                        ...
                        if (R && (j = u(R.call(new t))) !== Object.prototype && j.next && (i || u(j) === b || (f ? f(j, b) : a(j[w]) || p(j, w, _)), l(j, P, !0, !0), i && (h[P] = _)), y && v == O && k && k.name !== O && (!i && m ? d(M, "name", O) : (I = !0, F = function() { return o(k, this) })), v)
                ...
                2104: function(t, n, e) {
                    var r = e(4374),
                        ...
                        i = o.apply,
                        c = o.call;
                    t.exports = "object" == typeof Reflect && Reflect.apply || (r ? c.bind(i) : function() { return c.apply(i, arguments) })
                },
                9974: function(t, n, e) {
                    var r = e(1702),
                        o = e(9662),
                        i = e(4374),
                        c = r(r.bind);
                    t.exports = function(t, n) { return o(t), void 0 === n ? t : i ? c(t, n) : function() { return t.apply(n, arguments) } }
                },
                4374: function(t, n, e) {
                    var r = e(7293);
                ...
                1702: function(t, n, e) {
                    var r = e(4374),
                        ...
                        c = o.call,
                        a = r && i.bind(c, c);
                    t.exports = r ? function(t) { return t && a(t) } : function(t) { return t && function() { return c.apply(t, arguments) } }
                },
                5005: function(t, n, e) {
                    var r = e(7854),
                        o = e(614),
                        i = function(t) { return o(t) ? t : void 0 };
                    t.exports = function(t, n) { return arguments.length < 2 ? i(r[t]) : r[t] && r[t][n] }
                },
                1246: function(t, n, e) {
                    var r = e(648),
                        o = e(8173),
                        i = e(7497),
                        c = e(5112)("iterator");
                    t.exports = function(t) { if (null != t) return o(t, c) || o(t, "@@iterator") || i[r(t)] }
                },
                8554: function(t, n, e) {
                    var r = e(6916),
                        o = e(9662),
                        ...
                        a = e(1246),
                        s = TypeError;
                    t.exports = function(t, n) { var e = arguments.length < 2 ? a(t) : n; if (o(e)) return i(r(e, t)); throw s(c(t) + " is not iterable") }
                },
                8173: function(t, n, e) {
                    var r = e(9662);
                    t.exports = function(t, n) { var e = t[n]; return null == e ? void 0 : r(e) }
                },
                7854: function(t, n, e) {
                    var r = function(t) { return t && t.Math == Math && t };
                    t.exports = r("object" == typeof globalThis && globalThis) || r("object" == typeof window && window) || r("object" == typeof self && self) || r("object" == typeof e.g && e.g) || function() { return this }() || Function("return this")()
                },
                2597: function(t, n, e) {
                    var r = e(1702),
                        o = e(7908),
                ...
                8361: function(t, n, e) {
                    var r = e(1702),
                        ...
                        c = Object,
                        a = r("".split);
                    t.exports = o((function() { return !c("z").propertyIsEnumerable(0) })) ? function(t) { return "String" == i(t) ? a(t, "") : c(t) } : c
                },
                2788: function(t, n, e) {
                    var r = e(1702),
                        o = e(614),
                    ...
                    o(i.inspectSource) || (i.inspectSource = function(t) { return c(t) }), t.exports = i.inspectSource
                },
                9909: function(t, n, e) {
                    var r, o, i, c = e(8536),
                        a = e(7854),
                    ...
                    if (c || d.state) {
                        var m = d.state || (d.state = new y),
                            ...
                            x = s(m.has),
                            w = s(m.set);
                        r = function(t, n) { if (x(m, t)) throw new g(h); return n.facade = t, w(m, t, n), n }, o = function(t) { return b(m, t) || {} }, i = function(t) { return x(m, t) }
                    } else {
                        var S = p("state");
                        v[S] = !0, r = function(t, n) { if (l(t, S)) throw new g(h); return n.facade = t, f(t, S, n), n }, o = function(t) { return l(t, S) ? t[S] : {} }, i = function(t) { return l(t, S) }
                    }
                    t.exports = { set: r, get: o, has: i, enforce: function(t) { return i(t) ? o(t) : r(t, {}) }, getterFor: function(t) { return function(n) { var e; if (!u(n) || (e = o(n)).type !== t) throw g("Incompatible receiver, " + t + " required"); return e } } }
                },
                7659: function(t, n, e) {
                    var r = e(5112),
                        o = e(7497),
                ...
                4411: function(t, n, e) {
                    var r = e(1702),
                        ...
                        p = r(d.exec),
                        v = !d.exec(u),
                        h = function(t) { if (!i(t)) return !1; try { return l(u, f, t), !0 } catch (t) { return !1 } },
                        g = function(t) {
                            if (!i(t)) return !1;
                            switch (c(t)) {
                                case "AsyncFunction":
                            ...
                            try { return v || !!p(d, s(t)) } catch (t) { return !0 }
                        };
                    g.sham = !0, t.exports = !l || o((function() { var t; return h(h.call) || !h(Object) || !h((function() { t = !0 })) || t })) ? g : h
                },
                4705: function(t, n, e) {
                    var r = e(7293),
                        o = e(614),
                        i = /#|\.prototype\./,
                        c = function(t, n) { var e = s[a(t)]; return e == f || e != u && (o(n) ? r(n) : !!n) },
                        a = c.normalize = function(t) { return String(t).replace(i, ".").toLowerCase() },
                        s = c.data = {},
                        u = c.NATIVE = "N",
                        f = c.POLYFILL = "P";
                    t.exports = c
                ...
                2190: function(t, n, e) {
                    var r = e(5005),
                        ...
                        c = e(3307),
                        a = Object;
                    t.exports = c ? function(t) { return "symbol" == typeof t } : function(t) { var n = r("Symbol"); return o(n) && i(n.prototype, a(t)) }
                },
                9212: function(t, n, e) {
                    var r = e(6916),
                        o = e(9670),
                    ...
                    t.exports = function(t, n, e) {
                        ...
                        o(t);
                        try {
                            if (!(c = i(t, "return"))) { if ("throw" === n) throw e; return e }
                            c = r(c, t)
                        } catch (t) { a = !0, c = t }
                        if ("throw" === n) throw e;
                        if (a) throw c;
                ...
                3383: function(t, n, e) {
                    ...
                    var r, o, i, c = e(7293),
                        ...
                        p = l("iterator"),
                        v = !1;
                    [].keys && ("next" in (i = [].keys()) ? (o = u(u(i))) !== Object.prototype && (r = o) : v = !0), null == r || c((function() { var t = {}; return r[p].call(t) !== t })) ? r = {} : d && (r = s(r)), a(r[p]) || f(r, p, (function() { return this })), t.exports = { IteratorPrototype: r, BUGGY_SAFARI_ITERATORS: v }
                },
                ...
                6339: function(t, n, e) {
                    var r = e(7293),
                        ...
                        p = c && !r((function() { return 8 !== d((function() {}), "length", { value: 8 }).length })),
                    ...
                    Function.prototype.toString = h((function() { return o(this) && l(this).source || s(this) }), "toString")
                },
                4758: function(t) {
                    var n = Math.ceil,
                        e = Math.floor;
                    t.exports = Math.trunc || function(t) { var r = +t; return (r > 0 ? e : n)(r) }
                },
                735: function(t, n, e) {
                    var r = e(133);
                ...
                1574: function(t, n, e) {
                    ...
                    t.exports = !d || c((function() {
                        ...
                        return t[e] = 7, o.split("").forEach((function(t) { n[t] = t })), 7 != d({}, t)[e] || a(d({}, n)).join("") != o
                    })) ? function(t, n) {
                ...
                30: function(t, n, e) {
                    var r, o = e(9670),
                        ...
                        p = function(t) { t.write(d("")), t.close(); var n = t.parentWindow.Object; return t = null, n },
                        v = function() {
                    ...
                    a[f] = !0, t.exports = Object.create || function(t, n) { var e; return null !== t ? (l.prototype = o(t), e = new l, l.prototype = null, e[f] = t) : e = v(), void 0 === n ? e : i.f(e, n) }
                },
                6048: function(t, n, e) {
                    var r = e(9781),
                        o = e(3353),
                        ...
                        a = e(5656),
                        s = e(1956);
                    n.f = r && !o ? Object.defineProperties : function(t, n) { c(t); for (var e, r = a(n), o = s(n), u = o.length, f = 0; u > f;) i.f(t, e = o[f++], r[e]); return t }
                },
                3070: function(t, n, e) {
                    var r = e(9781),
                        o = e(4664),
                    ...
                    n.f = r ? i ? function(t, n, e) {
                        ...
                        if (c(t), n = a(n), c(e), o) try { return u(t, n, e) } catch (t) {}
                ...
                1236: function(t, n, e) {
                    ...
                    n.f = r ? l : function(t, n) {
                        if (t = a(t), n = s(n), f) try { return l(t, n) } catch (t) {}
                ...
                1156: function(t, n, e) {
                    ...
                    t.exports.f = function(t) { return a && "Window" == r(t) ? function(t) { try { return i(t) } catch (t) { return c(a) } }(t) : i(o(t)) }
                },
                8006: function(t, n, e) {
                    var r = e(6324),
                ...
                5181: function(t, n) { n.f = Object.getOwnPropertySymbols },
                9518: function(t, n, e) {
                    var r = e(2597),
                        o = e(614),
                        i = e(7908),
                        ...
                        u = Object,
                        f = u.prototype;
                    t.exports = a ? u.getPrototypeOf : function(t) { var n = i(t); if (r(n, s)) return n[s]; var e = n.constructor; return o(e) && n instanceof e ? e.prototype : n instanceof u ? f : null }
                },
                7976: function(t, n, e) {
                    var r = e(1702);
                ...
                5296: function(t, n) {
                    ...
                    var e = {}.propertyIsEnumerable,
                        ...
                        o = r && !e.call({ 1: 2 }, 1);
                    n.f = o ? function(t) { var n = r(this, t); return !!n && n.enumerable } : e
                },
                7674: function(t, n, e) {
                    var r = e(1702),
                        o = e(9670),
                    ...
                    t.exports = Object.setPrototypeOf || ("__proto__" in {} ? function() {
                        ...
                        return function(e, r) { return o(e), i(r), n ? t(e, r) : e.__proto__ = r, e }
                    }() : void 0)
                },
                288: function(t, n, e) {
                    "use strict";
                ...
                2140: function(t, n, e) {
                    var r = e(6916),
                        ...
                        i = e(111),
                        c = TypeError;
                    t.exports = function(t, n) { var e, a; if ("string" === n && o(e = t.toString) && !i(a = r(e, t))) return a; if (o(e = t.valueOf) && !i(a = r(e, t))) return a; if ("string" !== n && o(e = t.toString) && !i(a = r(e, t))) return a; throw c("Can't convert object to primitive value") }
                },
                3887: function(t, n, e) {
                    var r = e(5005),
                        o = e(1702),
                ...
                2999: function(t, n, e) {
                    var r = e(7293),
                        o = e(7854).RegExp,
                        i = r((function() { var t = o("a", "y"); return t.lastIndex = 2, null != t.exec("abcd") })),
                        c = i || r((function() { return !o("a", "y").sticky })),
                        a = i || r((function() { var t = o("^r", "gy"); return t.lastIndex = 2, null != t.exec("str") }));
                ...
                8003: function(t, n, e) {
                    ...
                    t.exports = function(t, n, e) { t && !e && (t = t.prototype), t && !o(t, i) && r(t, i, { configurable: !0, value: n }) }
                },
                6200: function(t, n, e) {
                    var r = e(2309),
                        o = e(9711),
                ...
                2309: function(t, n, e) {
                    var r = e(1913),
                        o = e(5465);
                    (t.exports = function(t, n) { return o[t] || (o[t] = void 0 !== n ? n : {}) })("versions", []).push({ version: "3.23.2", mode: r ? "pure" : "global", copyright: "© 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.23.2/LICENSE", source: "https://github.com/zloirock/core-js" })
                },
                8710: function(t, n, e) {
                    var r = e(1702),
                        o = e(9303),
                ...
                6532: function(t, n, e) {
                    ...
                    t.exports = function() {
                        var t = o("Symbol"),
                            ...
                            e = n && n.valueOf,
                            a = i("toPrimitive");
                        n && !n[a] && c(n, a, (function(t) { return r(e, this) }), { arity: 1 })
                    }
                },
                1400: function(t, n, e) {
                    var r = e(9303),
                ...
                9303: function(t, n, e) {
                    var r = e(4758);
                    t.exports = function(t) { var n = +t; return n != n || 0 === n ? 0 : r(n) }
                },
                7466: function(t, n, e) {
                    var r = e(9303),
                        o = Math.min;
                ...
                7593: function(t, n, e) {
                    var r = e(6916),
                        ...
                        u = TypeError,
                        f = s("toPrimitive");
                    t.exports = function(t, n) { if (!o(t) || i(t)) return t; var e, s = c(t, f); if (s) { if (void 0 === n && (n = "default"), e = r(s, t, n), !o(e) || i(e)) return e; throw u("Can't convert object to primitive value") } return void 0 === n && (n = "number"), a(t, n) }
                },
                4948: function(t, n, e) {
                    var r = e(7593),
                        o = e(2190);
                    t.exports = function(t) { var n = r(t, "string"); return o(n) ? n : n + "" }
                },
                1694: function(t, n, e) {
                    var r = {};
                ...
                9711: function(t, n, e) {
                    var r = e(1702),
                        ...
                        i = Math.random(),
                        c = r(1..toString);
                    t.exports = function(t) { return "Symbol(" + (void 0 === t ? "" : t) + ")_" + c(++o + i, 36) }
                },
                3307: function(t, n, e) {
                    var r = e(133);
                ...
                2222: function(t, n, e) {
                    ...
                    var r = e(2109),
                        ...
                        g = v >= 51 || !o((function() { var t = []; return t[h] = !1, t.concat()[0] !== t })),
                        y = d("concat"),
                        m = function(t) { if (!c(t)) return !1; var n = t[h]; return void 0 !== n ? !!n : i(t) };
                ...
                7327: function(t, n, e) {
                    ...
                    var r = e(2109),
                        o = e(2092).filter;
                    r({ target: "Array", proto: !0, forced: !e(1194)("filter") }, { filter: function(t) { return o(this, t, arguments.length > 1 ? arguments[1] : void 0) } })
                },
                1038: function(t, n, e) {
                    var r = e(2109),
                        o = e(8457);
                    r({ target: "Array", stat: !0, forced: !e(7072)((function(t) { Array.from(t) })) }, { from: o })
                },
                6699: function(t, n, e) {
                    "use strict";
                    var r = e(2109),
                        ...
                        i = e(7293),
                        c = e(1223);
                    r({ target: "Array", proto: !0, forced: i((function() { return !Array(1).includes() })) }, { includes: function(t) { return o(this, t, arguments.length > 1 ? arguments[1] : void 0) } }), c("includes")
                },
                6992: function(t, n, e) {
                    "use strict";
                    var r = e(5656),
                        ...
                        d = c.set,
                        p = c.getterFor(l);
                    t.exports = s(Array, "Array", (function(t, n) { d(this, { type: l, target: r(t), index: 0, kind: n }) }), (function() {
                        var t = p(this),
                            n = t.target,
                            e = t.kind,
                            r = t.index++;
                    ...
                    if (o("keys"), o("values"), o("entries"), !u && f && "values" !== v.name) try { a(v, "name", { value: "values" }) } catch (t) {}
                },
                7042: function(t, n, e) {
                    "use strict";
                    var r = e(2109),
                ...
                8309: function(t, n, e) {
                    var r = e(9781),
                        ...
                        u = /function\b(?:\s|\/\*[\S\s]*?\*\/|\/\/[^\n\r]*[\n\r]+)*([^\s(/]*)/,
                        f = i(u.exec);
                    r && !o && c(a, "name", { configurable: !0, get: function() { try { return f(u, s(this))[1] } catch (t) { return "" } } })
                },
                8862: function(t, n, e) {
                    var r = e(2109),
                        o = e(5005),
                        ...
                        S = /^[\uD800-\uDBFF]$/,
                        O = /^[\uDC00-\uDFFF]$/,
                        E = !v || s((function() { var t = o("Symbol")(); return "[null]" != h([t]) || "{}" != h({ a: t }) || "{}" != h(Object(t)) })),
                        _ = s((function() { return '"\\udf06\\ud834"' !== h("\udf06\ud834") || '"\\udead"' !== h("\udead") })),
                        A = function(t, n) {
                            var e = p(arguments),
                                r = n;
                            if ((l(n) || void 0 !== t) && !d(t)) return u(n) || (n = function(t, n) { if (f(r) && (n = c(r, this, t, n)), !d(n)) return n }), e[1] = n, i(h, null, e)
                        },
                        j = function(t, n, e) {
                            var r = y(e, n - 1),
                                o = y(e, n + 1);
                    ...
                    h && r({ target: "JSON", stat: !0, arity: 3, forced: E || _ }, {
                ...
                9660: function(t, n, e) {
                    var r = e(2109),
                        ...
                        c = e(5181),
                        a = e(7908);
                    r({ target: "Object", stat: !0, forced: !o || i((function() { c.f(1) })) }, { getOwnPropertySymbols: function(t) { var n = c.f; return n ? n(a(t)) : [] } })
                },
                1539: function(t, n, e) {
                    var r = e(1694),
                        o = e(8052),
                ...
                8783: function(t, n, e) {
                    ...
                    var r = e(8710).charAt,
                        ...
                        s = i.set,
                        u = i.getterFor(a);
                    c(String, "String", (function(t) { s(this, { type: a, string: o(t), index: 0 }) }), (function() {
                        var t, n = u(this),
                            e = n.string,
                            o = n.index;
                ...
                4032: function(t, n, e) {
                    ...
                    var r = e(2109),
                        ...
                        rt = s && f((function() { return 7 != m(q({}, "a", { get: function() { return q(this, "a", { value: 7 }).a } })).a })) ? function(t, n, e) {
                            var r = $(Y, n);
                            r && delete Y[n], q(t, n, e), r && t !== Y && q(Y, n, r)
                        } : q,
                        ot = function(t, n) { var e = Z[t] = m(U); return W(e, { type: G, tag: t, description: n }), s || (e.description = n), e },
                        it = function(t, n, e) { t === Y && it(tt, n, e), p(t); var r = h(n); return p(e), l(Z, r) ? (e.enumerable ? (l(t, N) && t[N][r] && (t[N][r] = !1), e = m(e, { enumerable: y(0, !1) })) : (l(t, N) || q(t, N, y(1, {})), t[N][r] = !0), rt(t, r, e)) : q(t, r, e) },
                        ct = function(t, n) {
                            p(t);
                            var e = v(n),
                                r = b(e).concat(ft(e));
                            return B(r, (function(n) { s && !i(at, e, n) || it(t, n, e[n]) })), t
                        },
                        at = function(t) {
                            var n = h(t),
                                e = i(J, this, n);
                ...
                763: function(t, n, e) {
                    ...
                    r({ target: "Symbol", stat: !0, forced: !s }, { for: function(t) { var n = c(t); if (i(u, n)) return u[n]; var e = o("Symbol")(n); return u[n] = e, f[e] = n, e } })
                },
                2165: function(t, n, e) { e(7235)("iterator") },
                2526: function(t, n, e) { e(4032), e(763), e(6620), e(8862), e(9660) },
                6620: function(t, n, e) {
                    var r = e(2109),
                        o = e(2597),
                        i = e(2190),
                    ...
                    r({ target: "Symbol", stat: !0, forced: !s }, { keyFor: function(t) { if (!i(t)) throw TypeError(c(t) + " is not a symbol"); if (o(u, t)) return u[t] } })
                },
                4747: function(t, n, e) {
                    var r = e(7854),
                        o = e(8324),
                        ...
                        c = e(8533),
                        a = e(8880),
                        s = function(t) { if (t && t.forEach !== c) try { a(t, "forEach", c) } catch (n) { t.forEach = c } };
                ...
                3948: function(t, n, e) {
                    var r = e(7854),
                        ...
                        d = function(t, n) {
                            if (t) {
                                if (t[u] !== l) try { a(t, u, l) } catch (n) { t[u] = l }
                                if (t[f] || a(t, f, n), o[n])
                                    for (var e in c)
                                        if (t[e] !== c[e]) try { a(t, e, c[e]) } catch (n) { t[e] = c[e] }
                            }
                        };
        ...
        function e(r) { var o = n[r]; if (void 0 !== o) return o.exports; var i = n[r] = { exports: {} }; return t[r](i, i.exports, e), i.exports }
        ...
        return function() {
            "use strict";
            e.d(r, { default: function() { return b } }), e(9601), e(1539), e(4747), e(2222), e(7327), e(6699), e(2526), e(1817), e(2165), e(6992), e(8783), e(3948), e(1038), e(7042), e(8309), e(4916);
            var t = !1;
            if ("undefined" != typeof window) {
                var n = {get passive() { t = !0 } };
            ...
            var o = "undefined" != typeof window && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || "MacIntel" === window.navigator.platform && window.navigator.maxTouchPoints > 1),
                ...
                u = void 0,
                f = void 0,
                l = function(t) { return i.some((function(n) { return !(!n.options.allowTouchMove || !n.options.allowTouchMove(t)) })) },
                d = function(t) { var n = t || window.event; return !!l(n.target) || n.touches.length > 1 || (n.preventDefault && n.preventDefault(), !1) },
                p = function(n, e) {
                    if (n) {
                        if (!i.some((function(t) { return t.targetElement === n }))) {
                            var r = { targetElement: n, options: e || {} };
                            i = [].concat(function(t) { if (Array.isArray(t)) { for (var n = 0, e = Array(t.length); n < t.length; n++) e[n] = t[n]; return e } return Array.from(t) }(i), [r]), o ? window.requestAnimationFrame((function() {
                                if (void 0 === u) {
                            ...
                            }(e), o && (n.ontouchstart = function(t) { 1 === t.targetTouches.length && (a = t.targetTouches[0].clientY) }, n.ontouchmove = function(t) { 1 === t.targetTouches.length && function(t, n) { var e = t.targetTouches[0].clientY - a;!l(t.target) && (n && 0 === n.scrollTop && e > 0 || function(t) { return !!t && t.scrollHeight - t.scrollTop <= t.clientHeight }(n) && e < 0 ? d(t) : t.stopPropagation()) }(t, n) }, c || (document.addEventListener("touchmove", d, t ? { passive: !1 } : void 0), c = !0))
                        }
                    } else console.error("disableBodyScroll unsuccessful - targetElement must be provided when calling disableBodyScroll on IOS devices.")
                },
                v = function(n) {
                    n ? (i = i.filter((function(t) { return t.targetElement !== n })), o && (n.ontouchstart = null, n.ontouchmove = null, c && 0 === i.length && (document.removeEventListener("touchmove", d, t ? { passive: !1 } : void 0), c = !1)), o ? function() {
                        if (void 0 !== u) {
            ...
            function g(t, n) { if (!(t instanceof n)) throw new TypeError("Cannot call a class as a function") }
            ...
            var m = function() {
                    function t(n) {
                        ...
                        g(this, t);
                        var r = { controlColor: "#FFFFFF", controlShadow: !0, addCircle: !1, addCircleBlur: !0, showLabels: !1, labelOptions: { before: "Before", after: "After", onHover: !1 }, smoothing: !0, smoothingAmount: 100, hoverStart: !1, verticalMode: !1, startingPoint: 50, fluidMode: !1 };
                    ...
                    var n, e;
                    return n = t, (e = [{ key: "mount", value: function() { this.safariAgent && (this.settings.smoothing = !1), this._shapeContainer(), this._getImages(), this._buildControl(), this._events() } }, {
                        key: "_events",
                        value: function() {
                            var t = this;
                            this.el.addEventListener("mousedown", (function(n) { t._activate(!0), document.body.classList.add("icv__body"), p(t.el, { reserveScrollBarGap: !0 }), t._slideCompare(n) })), this.el.addEventListener("mousemove", (function(n) { return t.active && t._slideCompare(n) })), this.el.addEventListener("mouseup", (function() { return t._activate(!1) })), document.body.addEventListener("mouseup", (function() { document.body.classList.remove("icv__body"), v(t.el), t._activate(!1) })), this.control.addEventListener("touchstart", (function(n) { t._activate(!0), document.body.classList.add("icv__body"), p(t.el, { reserveScrollBarGap: !0 }) })), this.el.addEventListener("touchmove", (function(n) { t.active && t._slideCompare(n) })), this.el.addEventListener("touchend", (function() { t._activate(!1), document.body.classList.remove("icv__body"), v(t.el) })), this.el.addEventListener("mouseenter", (function() {
                                ...
                                t.arrowAnimator.forEach((function(e, r) { e.style.cssText = "\n        ".concat(t.settings.verticalMode ? "transform: translateY(".concat(n[1] * (0 === r ? 1 : -1), "px);") : "transform: translateX(".concat(n[1] * (0 === r ? 1 : -1), "px);"), "\n        ") }))
                    ...
                    }, { key: "_activate", value: function(t) { this.active = t } }, {
                        key: "_shapeContainer",
                        value: function() {
                    ...
                    }]) && y(n.prototype, e), Object.defineProperty(n, "prototype", { writable: !1 }), t
                }(),
                b = m
        }(), r.default
    }()
